...
const list_div = document.querySelector("#player_list_display > div");
const control = document.querySelector("#player_control_panel");
const sidebar = document.querySelector("#player_list_sidebar");
// const play = control.querySelector("#play");
// const pause = control.querySelector("#pause");

const player = new Player(list_div, control,sidebar);
